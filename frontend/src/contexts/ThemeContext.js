...
export const themes = {
  light: {
    ...
    accentGradient:
      "linear-gradient(135deg, #30e8b0 0%, #6ad1fa 50%, #0d9488 100%)",
  ...
  dark: {
    ...
    accentGradient:
      "linear-gradient(135deg, #30e8b0 0%, #6ad1fa 50%, #64748b 100%)",
  ...
  cornell: {
    ...
    accentGradient:
      "linear-gradient(135deg, #d32f2f 0%, #f44336 50%, #b71c1c 100%)",
  ...
  ocean: {
    ...
    accentGradient:
      "linear-gradient(135deg, #0284c7 0%, #0ea5e9 50%, #0369a1 100%)",
  ...
  lavender: {
    ...
    accentGradient:
      "linear-gradient(135deg, #9333ea 0%, #a855f7 50%, #7c3aed 100%)",
...
export const ThemeProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    root.style.setProperty(
      ...
      currentThemeData.textSecondary
    );
